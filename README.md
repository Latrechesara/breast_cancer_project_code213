...
```bash
breast_cancer_project_code213/
│
├── images/
│
├── plotly_app_breaset_cancer/
│   ├── assets/
│   ├── pages/
│   ├── app.py
│   ├── Procfile
...
├── 2-Model_Training_Comparison.ipynb
├── 3-Final_model_Breast_cancer_model.ipynb
